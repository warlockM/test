...
export default function Home() {
  ...
  return (
    <div class="container m-auto">
      ...
      <h3 class="text-slate-900 text-center">
        Heal100 is an Initiative that cater to the allround development of young
        children{" "}
      </h3>
      <h3 class="text-slate-900 text-center">
        and address their mental wellness needs
      </h3>
      ...
      <div class="flex place-content-center">
        <button
          class="bg-blue-900 text-white text-sm rounded-3xl p-4 shadow-lg shadow-slate-500 font-bold tracking-wide"
